...
С помощью команды __git branch__ можно посмотреть, какие в проекте есть ветки и в какой из них вы сейчас находитесь (отмечена звездочкой).
...
2) Сохраняем его версию в __git - git add . && git commit -m "комментарий".__
...
6) Сохраняем новый файл в __git - git add . && git commit -m "комментарий".__
7) Можем сравнивать файлы из разных веток g__it diff <название_ветки1> <название_ветки2>__ <br>
